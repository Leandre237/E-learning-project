...
<div class="container-fluid remove-vid-marg">
    ...
    if(!isset($_SESSION['is_login'])){
      echo '<a href="student/loginstudent.php" class="btn btn-danger mt-3" data-bs-toggle="modal" data-bs-target="#stuRegModalCent">Get Started </a>';
    } else {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-footer">
              <p class="card-text d-inline">Price <small><del>'.$row["course_original_price"].' CAD </del></small><span  class="font-weight-bolder">// '.$row["course_price"].' CAD</span></p>
