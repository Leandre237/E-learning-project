    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <ul class="navbar-nav custom-nav p-3">
        ...
        if(isset($_SESSION['is_login'])){
          ...
          echo '<li class="nav-item custom-nav-item"><a href="student/loginstudent.php" class="nav-link" data-bs-toggle="modal" data-bs-target="#stuLoginModalCent">Login</a></li>
          <li class="nav-item custom-nav-item"><a href="student/studentProfile.php" class="nav-link"  data-bs-toggle="modal" data-bs-target="#stuRegModalCent">Signup</a></li>';
        }
